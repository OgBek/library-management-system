...
scheduler_events = {
    "daily": [
        "library_management.library_management.overdue_notification.send_overdue_notifications"
    ]
}
...
override_whitelisted_methods = {
    ...
    # Reservation APIs — ✅ CORRECTED PATHS
    "library_management.api.reservation_api.get_reservations": "library_management.api.reservation_api.get_reservations",
    "library_management.api.reservation_api.get_reservation": "library_management.api.reservation_api.get_reservation",
    "library_management.api.reservation_api.create_reservation": "library_management.api.reservation_api.create_reservation",
    "library_management.api.reservation_api.update_reservation": "library_management.api.reservation_api.update_reservation",
    "library_management.api.reservation_api.delete_reservation": "library_management.api.reservation_api.delete_reservation",
